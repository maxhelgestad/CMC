...
//	private String location;
 ...
 public Criteria(String name, String state, String location, String control, int numStudents, float mfRatio,
  ...
  this.numStudents = numStudents;
	 ...
	 * 
	 * @param name
	 *            name of the university - can be substring that the name might
	 *            contain
	 * @param state
	 *            name of the state - can be substring that the state name might
	 *            contain
	 * @param location
	 *            name of the location - can be substring that the location might
	 *            contain
	 * @param control
	 *            name of the control - can be substring that the control might
	 *            contain
	 * @param numStudentsB
	 *            lower bound of number of students - if not entered will be -1
	 * @param numStudentsT
	 *            upper bound of number of students - if not entered will be
	 *            MAX_VALUE
	 * @param mfRatioB
	 *            lower bound of male female ratio - if not entered will be -1
	 * @param mfRatioT
	 *            upper bound of male female ratio - if not entered will be
	 *            MAX_VALUE
	 * @param satVerbalB
	 *            lower bound of SATVerbal - if not entered will be -1
	 * @param satVerbalT
	 *            upper bound of SATverbal - if not entered will be MAX_VALUE
	 * @param satMathB
	 *            lower bound of SATMath - if not entered will be -1
	 * @param satMathT
	 *            upper bound of SATMath - if not entered will be MAX_VALUE
	 * @param expensesB
	 *            lower bound of expenses - if not entered will be -1
	 * @param expensesT
	 *            upper bound of expenses - if not entered will be MAX_VALUE
	 * @param financialAidB
	 *            lower bound of financial aid percentage - if not entered will be
	 *            -1
	 * @param financialAidT
	 *            upper bound of financial aid percentage - if not entered will be
	 *            MAX_VALUE
	 * @param numApplicantsB
	 *            lower bound of number of applicants - if not entered will be -1
	 * @param numApplicantsT
	 *            upper bound of number of applicants - if not entered will be
	 *            MAX_VALUE
	 * @param admitionRateB
	 *            lower bound of admition rate - if not entered will be -1
	 * @param admitionRateT
	 *            upper bound of admition rate - if not entered will be MAX_VALUE
	 * @param percentEnrolledB
	 *            lower bound of percent Enrolled - if not entered will be -1
	 * @param percentEnrolledT
	 *            upper bound of percent Enrolled - if not entered will be MAX_VALUE
	 * @param academicsB
	 *            lower bound of academics - if not entered will be -1
	 * @param academicsT
	 *            upper bound of academics - if not entered will be MAX_VALUE
	 * @param socialB
	 *            lower bound of social - if not entered will be -1
	 * @param socialT
	 *            upper bound of social - if not entered will be MAX_VALUE
	 * @param qualOfLifeB
	 *            lower bound of quality of life - if not entered will be -1
	 * @param qualOfLifeT
	 *            upper bound of quality of life - if not entered will be MAX_VALUE
	 */
	public Criteria(String name, String state, String location, String control, int numStudentsB, int numStudentsT,
			float mfRatioB, float mfRatioT, float satVerbalB, float satVerbalT, float satMathB, float satMathT,
			float expensesB, float expensesT, float financialAidB, float financialAidT, int numApplicantsB,
			int numApplicantsT, float admitionRateB, float admitionRateT, float percentEnrolledB,
			float percentEnrolledT, int academicsB, int academicsT, int socialB, int socialT, int qualOfLifeB,
			int qualOfLifeT) {
